...
public class PieChart extends JFrame {
	...
	public PieChart(String title, Map<String, Float> datas) {
		super(title);
		JPanel localJPanel = createDemoPanel(title, datas);
	...
	private static JFreeChart createChart(String title,	PieDataset paramPieDataset) {
		JFreeChart localJFreeChart = ChartFactory.createPieChart(title, paramPieDataset, true, true, false);
	...
	public static JPanel createDemoPanel(String title, Map<String, Float> donnees) {
